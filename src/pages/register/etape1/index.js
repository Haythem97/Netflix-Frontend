      ...
      <div>
        <div >
          <div>
            ...
            <div>
              <span id="" className={styles.et2}>ÉTAPE <b>1</b> SUR <b>3</b></span>
              <br/>
              <br/>
              <h3 className={styles.se}>Créez un mot de passe pour <br/>activer votre abonnement</h3>
            </div>
          </div>
         <br/> <br/>
         ...
         <div className={styles.login__group}></div>
            <form className={styles.form} onSubmit={(e) => handleSubmit(e)}>
                ...
                />
                            <br/>
                <input className={styles.login__sign_in} value="Suivant" type="submit"/>
                {
                error ? (
